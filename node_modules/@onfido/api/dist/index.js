...
const convertAxiosErrorToOnfidoError = async (error) => {
    ...
    const body = data instanceof stream.Readable ? await readFullStream(data) : data;
...
exports.OnfidoApiError = OnfidoApiError;
exports.OnfidoDownload = OnfidoDownload;
exports.OnfidoError = OnfidoError;
